...
def calcularPrediccion(sentence, maxNgram, maxNumPaths, maxNumWords, listWords, listWordsInf, dictNgram, dictNgramInf, dictBackoff, dictBackoffInf, verbs_array, listDefaultPaths): 
	...
	pathsSelected = viterbiNbest(sentenceInf, maxNgram, maxNumPaths, maxNumWords, listWordsInf, dictNgramInf, dictBackoffInf, listDefaultPaths)  #Se ejecuta el algoritmo Viterbi para obtener las predicciones de continuación de la frase inicial
